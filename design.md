...
The system processes student resumes through an AI-powered pipeline that extracts skills, calculates eligibility scores for internships (available on different platforms), identifies skill gaps between internship and students skills , and generates personalized projects or set of projects that can teach the student with the requirement skills. All data flows through a RESTful API with JWT-based authentication ensuring security.
